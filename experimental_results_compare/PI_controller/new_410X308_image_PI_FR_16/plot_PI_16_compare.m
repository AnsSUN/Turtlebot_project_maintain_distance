...
%% loading data for constant velocity 0.07 m/s with PI controller, camera sensors frame rate =16
...
hold on
ax(1) = subplot(2,1,1);
plot(indx_pt07(1:151), ego_bot_dist_pt07(1:151), 'r', indx_pt07(1:151), const_dist_plot(1:151), 'b')
xlabel('Time')
ylabel('distance (in m)')
title(' distance(measured by sensor) between lead and ego vehicle (m), all sensors')
legend('relative distance of lead and ego vehicle', 'constant relative distance to maintain = 0.4m')
ax(2) = subplot(2,1,2);
plot(indx_pt07(1:151), ego_bot_vel_pt07(1:151), 'r', indx_pt07(1:151), lead_bot_vel_vari(1:151), 'b')
xlabel('Time')
ylabel('velocity (in m/s)')
