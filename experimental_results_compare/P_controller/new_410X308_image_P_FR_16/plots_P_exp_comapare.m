...
const_dist = 0.4;
%% loading data for constant velocity 0.07 m/s with P controller, all sensors frame rate =16
...
%% loading data for constant velocity 0.07 m/s with P controller, camera sensors frame rate =16

ego_bot_vel_pt07_load = load('V_x_relsave_plot_camera.mat');
ego_bot_vel_pt07 = ego_bot_vel_pt07_load.V_x_rel_save;
ego_bot_dist_pt07_load = load('x_relsave_plot_camera.mat');
ego_bot_dist_pt07 = ego_bot_dist_pt07_load.x_rel_save(1, :);
...
%% loading data for variable velocity with P controller, all sensors frame rate =16
...
shift_arry_7_ele = 0.1*ones(1,40);
