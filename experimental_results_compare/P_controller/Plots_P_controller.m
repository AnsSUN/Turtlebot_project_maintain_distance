...
const_dist = 0.4;
%% loading data for constant velocity 0.07 m/s with P controller, all sensors frame rate =5

ego_bot_vel_pt07_load = load('V_x_relsave_plot_both_sensors.mat');
ego_bot_vel_pt07 = ego_bot_vel_pt07_load.V_x_rel_save;
ego_bot_dist_pt07_load = load('x_relsave_plot_both_sensors.mat');
...
title(' velocity of lead and ego vehicle by P controller (m/s), all sensors')
legend('velocity of ego vehicle', 'velocity of lead vehicle')
hold off

%% loading data for constant velocity 0.07 m/s with P controller, LDS sensors frame rate =5
...
xlabel('Time')
ylabel('velocity (in m/s)')
title(' velocity of lead and ego vehicle by P controller (m/s), LDS sensors')
legend('velocity of ego vehicle', 'velocity of lead vehicle')
hold off


%% loading data for constant velocity 0.07 m/s with P controller, camera sensors frame rate =05
...
xlabel('Time')
ylabel('velocity (in m/s)')
title(' velocity of lead and ego vehicle by P controller (m/s), camera sensors')
legend('velocity of ego vehicle', 'velocity of lead vehicle')
hold off

%% loading data for variable velocity with P controller, all sensors frame rate =5

ego_bot_vel_pt07_load = load('step_V_x_relsave_plot.mat');
ego_bot_vel_pt07 = ego_bot_vel_pt07_load.V_x_rel_save;
ego_bot_dist_pt07_load = load('step_x_relsave_plot.mat');
ego_bot_dist_pt07 = ego_bot_dist_pt07_load.x_rel_save(1,1:end);
...
shift_arry_7_ele = 0.1*ones(1,27);
...
xlabel('Time')
ylabel('velocity (in m/s)')
title(' step velocity of lead and ego vehicle by P controller (m/s), all sensors')
legend('velocity of ego vehicle', 'velocity of lead vehicle')
hold off