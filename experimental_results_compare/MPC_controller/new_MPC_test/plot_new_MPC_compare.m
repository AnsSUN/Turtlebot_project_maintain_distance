...
ego_bot_vel_pt07_load = load('V_x_relsave_plot_all_const.mat');
ego_bot_vel_pt07 = ego_bot_vel_pt07_load.V_x_rel_save;
ego_bot_dist_pt07_load = load('x_relsave_plot_all_const.mat');
...
%% loading data for constant velocity 0.07 m/s with MPC controller, LDS sensors frame rate =16
...
%% loading data for constant velocity 0.07 m/s with MPC controller, camera sensors frame rate =16
...
shift_arry_7_ele = 0.1*ones(1,50);
...
hold on
ax(1) = subplot(2,1,1);
plot(indx_pt07(1:148), ego_bot_dist_pt07(1:148), 'r', indx_pt07(1:148), const_dist_plot(1:148), 'b')
xlabel('Time')
ylabel('distance (in m)')
title(' distance(measured by sensor) between lead and ego vehicle (m), all sensors')
legend('relative distance of lead and ego vehicle', 'constant relative distance to maintain = 0.4m')
ax(2) = subplot(2,1,2);
plot(indx_pt07(1:148), ego_bot_vel_pt07(1:148), 'r', indx_pt07(1:148), lead_bot_vel_vari(1:148), 'b')
xlabel('Time')
ylabel('velocity (in m/s)')
