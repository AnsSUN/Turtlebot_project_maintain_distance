...
function y_vis = y_coord_estimation_vision_410X308(pix_fromx, x_rel_dist_vis) %#codegen
   ...
   pixels = bboxes2(1)+bboxes2(3) - 205; % change 320 i.e. 1/2*(size of image in x direction) value according to pixel size of the image
   f= (pixels*9)/4; % constant
   new_pixel_value = pix_fromx - 205; % change 320 i.e. 1/2*(size of image in x direction) value according to pixel size of the image
