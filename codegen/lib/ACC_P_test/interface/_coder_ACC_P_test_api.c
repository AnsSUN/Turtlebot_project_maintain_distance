 ...
 * Return Type  : void
 */
void ACC_P_test_api(const mxArray * const prhs[6], int32_T nlhs, const mxArray
                    *plhs[1])
{
  real32_T rel_velx;
  real32_T rel_vely;
  ...
  rel_velx = ACC_P_test(rel_velx, rel_vely, rel_posx, rel_posy, vel_egox,
                        vel_egoy);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(rel_velx);
}
 ...
 * Return Type  : void
 */
void ACC_P_test_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void ACC_P_test_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_ACC_P_test_api.c
 *
 * [EOF]
 */
